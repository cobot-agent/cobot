...
func TestWorkspaceSandbox_PathUnderRoot(t *testing.T) {
	dir := t.TempDir()
	s := &cobot.SandboxConfig{Root: dir}
...
func TestWorkspaceSandbox_PathUnderAllowPaths(t *testing.T) {
	dir := t.TempDir()
	s := &cobot.SandboxConfig{Root: "/nonexistent", AllowPaths: []string{dir}}
...
func TestWorkspaceSandbox_PathUnderReadonlyPaths(t *testing.T) {
	dir := t.TempDir()
	s := &cobot.SandboxConfig{Root: "/nonexistent", ReadonlyPaths: []string{dir}}
...
func TestWorkspaceSandbox_PathOutsideAll(t *testing.T) {
	s := &cobot.SandboxConfig{Root: "/nonexistent"}
